  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      ...
      >
        ...
        {state !== "login" && (
          <div className="flex items-center mt-6 w-full bg-white/5 ring-2 ring-white/10 focus-within:ring-rose-500/60 h-12 rounded-full overflow-hidden pl-6 gap-2 transition-all ">
            <svg
        ...
        <button
          type="submit"
          className="mt-2 w-full h-11 rounded-full text-white bg-rose-600 hover:bg-rose-500 transition "
        >
          {state === "login" ? "Login" : "Sign up"}
        </button>
        ...
        >
          ...
          <span className="text-rose-400 hover:underline ml-1">Click here</span>
        </p>
      </form>
      {/* Soft Backdrop*/}
      <SoftBackdrop />
