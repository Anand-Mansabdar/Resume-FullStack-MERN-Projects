  ...
  if (!orders.length) {
    return (
      <div className="px-4 md:px-16 lg:px-24 xl:px-32">
        <div className="max-w-2xl mx-auto mt-14 bg-white rounded-xl border border-gray-300 p-8 text-center">
          <h3 className="text-lg font-semibold">No orders yet</h3>
          <p className="text-sm text-neutral-500 mt-2">
            You haven't purchased any listing(s) yet.
          </p>
        </div>
      </div>
    );
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div>
                      ...
                      <div className="flex gap-2 mt-2">
                        ...
                        {listing.monetized && (
                          <span className="flex items-center text-xs bg-green-50 text-green-500 px-2 py-1 rounded-md">
                    ...
                    <div className="text-right">
                      ...
                      <p className="text-sm text-neutral-50">USD</p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="mt-4 md:mt-0 pt-4">
                  <div className="space-y-2">
                    {credential.updatedCredential.map((cred) => (
                      <div
                        key={cred.name}
                        className="flex items-center justify-between gap-3 bg-neutral-50 rounded-md p-2"
                      >
                        <div>
                        ...
                        <div className="flex items-center gap-2">
                          <code className="text-sm font-mono">
                            {maskPassword(cred.value, cred.type)}
                          </code>
                          <button
                            ...
                            className="px-2 py-1 text-xs bg-white border border-neutral-200 rounded hover:shadow"
                          >
