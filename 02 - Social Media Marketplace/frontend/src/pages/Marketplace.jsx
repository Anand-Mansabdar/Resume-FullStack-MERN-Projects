...
const Marketplace = () => {
  ...
  // State Variables
  const [showFilterOnPhone, setShowFilterOnPhone] = useState(false);
    ...
    <div className="px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      <div className="flex items-start justify-between gap-8 pb-8 relative">
        <FilterSidebar
          ...
          filters={filters}
          showFilterOnPhone={showFilterOnPhone}
          setShowFilterOnPhone={setShowFilterOnPhone}
        />
