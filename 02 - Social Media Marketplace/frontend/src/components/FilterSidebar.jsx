...
const FilterSidebar = ({
  ...
  return (
    <div
      className={`${
        showFilterOnPhone ? "max-sm:fixed" : "max-sm:hidden"
      }max-sm:inset-0 z-100 max-sm:h-screen max-sm:overflow-scroll bg-white rounded-lg shadow-sm border border-neutral-200 h-fit sticky top-24 md:min-w-75`}
    >
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <X
              ...
              className="size-6 text-gray-500 hover:text-gray-700 p-1 hover:bg-neutral-100 rounded transition-colors cursor-pointer"
            />
            <button
              onClick={() => setShowFilterOnPhone(false)}
              className="sm:hidden text-sm border text-neutral-700 px-3 py-1 rounded"
            >
              Apply
            </button>
          </div>
      ...
      <div className="p-4 space-y-6 sm:max-h-[calc(100vh-200px)] overflow-y-scroll no-scrollbar ">
        ...
        <div className="flex items-center justify-between">
          <input
            ...
            className="w-full text-sm px-3 py-2 border border-neutral-300 rounded-md outline-indigo-500"
          />
        </div>
        ...
        <div className="">
          ...
          {expandedSections.followers && (
            <select
              ...
              className="w-full px-3 py-2 border border-gray-300 rounded-lg text-neutral-700 outline-indigo-500"
            >
