...
const ResumeBuilder = () => {
  ...
  // Function to change resume visibility(public/private)
  ...
  const handleShare = () => {
    const frondendUrl = window.location.href.split("/app/")[0];
    const resumeUrl = frondendUrl + "/view/" + resumeId;
          ...
          <div className="relative lg:col-span-5 rounded-lg overflow-hidden">
            <div className="bg-white rounded-lg shadow-sm border border-neutral-200 p-6 pt-1">
              ...
              <button
                ...
                className="bg-linear-to-r from-indigo-100 to-indigo-200 ring-indigo-300 text-indigo-600 ring hover:ring-indigo-400 transition-all rounded-md px-6 py-2 mt-6 text-sm "
              >
                Save Changes
              </button>
            </div>
            ...
            <div className="relative w-full">
              ...
              <div className="absolute bottom-3 left-0 right-0 flex items-center justify-end gap-2">
                ...
                <button
                  ...
                  className="flex items-center p-2 px-4 gap-2 text-xs bg-linear-to-br from-indigo-100 to-indigo-200 text-indigo-600 ring-indigo-300 rounded-lg hover:ring transition-colors "
                >
